...
#define ENV_STR_PRODUCT_NAME            "product_name"
#define ENV_STR_PRODUCT_VERSION         "product_ver"
#define ENV_STR_VENDOR_NAME             "vendor_name"
#define ENV_STR_PRODUCT_LANGUAGE        "product_language"
#define ENV_STR_VENDOR_URL              "vendor_url"
#define ENV_STR_PRODUCT_ID              "product_id"
#define ENV_STR_SPECIAL_ID              "special_id"
...
int  sysmgr_cfg_getProductInfoFromEnv(PRODUCT_INFO_STRUCT *productInfo);
